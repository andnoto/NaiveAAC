package com.example.NaiveAAC.activities.Game.Balloon.Utils;
...
public class SoundHelper {
    ...
    public SoundHelper(AppCompatActivity activity) {
        ...
        mVolume = (float) (audioManager != null ?
    ...
    public void prepareMusicPlayer(@NonNull Context context) {
        mMusicPlayer = MediaPlayer.create(context.getApplicationContext(), R.raw.balloon_game_music);
