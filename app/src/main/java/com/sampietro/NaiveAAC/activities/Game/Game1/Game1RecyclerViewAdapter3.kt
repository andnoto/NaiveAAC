 ...
 *
 * **Game1RecyclerViewAdapter3** adapter for game1
 *
 ...
 */
class Game1RecyclerViewAdapter3(
    private val context: Context, //
    private val realm: Realm,
    private val galleryList: ArrayList<Game1ArrayList>
) : RecyclerView.Adapter<Game1RecyclerViewAdapter3.ViewHolder>() {
    //
    ...
    */
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.activity_game_1_cell_layout_3, viewGroup, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            img = view.findViewById<View>(R.id.img3) as ImageView
            img2 = view.findViewById<View>(R.id.img3_2) as ImageView
            img3 = view.findViewById<View>(R.id.img3_3) as ImageView
        }
    }
}