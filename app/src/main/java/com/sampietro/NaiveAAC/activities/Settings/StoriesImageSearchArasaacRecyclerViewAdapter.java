...
import com.sampietro.NaiveAAC.activities.Game.Game1.Game1RecyclerViewAdapterInterface;
 ...
 * <p><b>StoriesImageSearchArasaacRecyclerViewAdapter</b> adapter for settings
 * </p>
 ...
 */
public class StoriesImageSearchArasaacRecyclerViewAdapter
        extends RecyclerView.Adapter<StoriesImageSearchArasaacRecyclerViewAdapter.ViewHolder> {
    public StoriesImageSearchArasaacRecyclerViewAdapterInterface listener=null;
    //
     ...
     * @see Game1ArrayList
     * @see StoriesImageSearchArasaacRecyclerViewAdapterInterface
     */
    public StoriesImageSearchArasaacRecyclerViewAdapter
            (Context context, ArrayList<Game1ArrayList> galleryList) {
        this.galleryList = galleryList;
        this.context = context;
        //
        Activity activity = (Activity) context;
        listener=(StoriesImageSearchArasaacRecyclerViewAdapterInterface) activity;
    }
    /**
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_game_1_cell_layout_1, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                listener.onItemClick(view, galleryList.get(i).getImage_title(), galleryList.get(i).getUrl() );
            }
        });
    }
    /**
