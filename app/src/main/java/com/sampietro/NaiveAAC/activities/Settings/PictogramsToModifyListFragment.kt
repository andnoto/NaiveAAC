...
/**
 * <h1>PictogramsToModifyListFragment</h1>
 *
 * **PictogramsToModifyListFragment** UI for pictograms to modify settings
 *
 *
 * @version     5.0, 01/04/2024
 * @see SettingsActivity
 */
class PictogramsToModifyListFragment() : FragmentAbstractClassWithoutConstructor()  {
    //
    ...
    override fun onCreateView(
        ...
        rootView =
            inflater.inflate(R.layout.activity_settings_pictograms_to_modify_list, container, false)
        // logic of fragment
