 ...
 *
 * **Game1RecyclerViewAdapter2** adapter for game1
 *
 ...
 */
class Game1RecyclerViewAdapter2(
    private val context: Context, //
    private val realm: Realm,
    private val galleryList: ArrayList<Game1ArrayList>
) : RecyclerView.Adapter<Game1RecyclerViewAdapter2.ViewHolder>() {
    //
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.activity_game_1_cell_layout_2, viewGroup, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            img2 = view.findViewById<View>(R.id.img2_2) as ImageView
            img3 = view.findViewById<View>(R.id.img2_3) as ImageView
        }
    }
}