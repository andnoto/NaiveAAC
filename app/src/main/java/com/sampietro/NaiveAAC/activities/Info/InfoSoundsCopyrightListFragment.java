 ...
 * <p><b>InfoSoundsCopyrightListFragment</b> UI for Sounds copyright list
 * </p>
 *
 * @version
 ...
 * @see InfoActivity
 */
public class InfoSoundsCopyrightListFragment extends InfoFragmentAbstractClass {
    private Realm realm;
    //
    private ListView listView=null;
    private SoundsCopyrightAdapter adapter;
    /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        myTextView.setText("COPYRIGHT SUONI");
        // ListView
        ...
        RealmResults<Sounds> results;
        results = realm.where(Sounds.class).findAll();
        //
        ...
        //
        adapter=new SoundsCopyrightAdapter(ctext, results, listView);
        //
